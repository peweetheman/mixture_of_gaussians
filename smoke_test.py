...
DATA_DIR = r'C:\Users\Patrick\Documents\Spring_2019\CSC_246\mixture_of_gaussians' #TODO: change this to wherever you put the data if working o a different machine
SIGFIG_NUM = 5
...
def get_output(filename):
    import subprocess
    cmd = None
    if filename.endswith('_em_gaussian.py'): #WARNING I CHANGED THE CMD , ADD BACK "./"!!!!!!
